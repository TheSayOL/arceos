...
def main():
    ...
    os.system("riscv64-linux-musl-gcc c/a.c -o a")
    os.system("riscv64-linux-musl-gcc c/b.c -o b")
    ...
    for i, data in enumerate(app_data):
        ...
        file.write(os.path.getsize(f'{APP_NAMES[i]}').to_bytes(HEADER_ALIGN, 'little')) # app_size: data size
        # wrte app data
        file.write(data)
    file.close() # save 

    # extend temp file to 32M, and rename it 
    os.system(f'dd if=./temp of=./{APPS_BIN} bs=32M conv=sync')
